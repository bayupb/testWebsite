<div class="py-12">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @if($openModal)
            @include('livewire.modal.penempatan-modal')
            @endif
            <table class="table-fixed w-full mt-4 items-center justify-center">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td class="border px-4 py-2">{{ $penempatan->nama_penempatan }}</td>
                        <td class="border px-4 py-2 flex">
                            <button wire:click="edit({{ $penempatan->id }})"
                                class="flex px-4 py-2 bg-gray-500 text-gray-900 cursor-pointer">Edit</button>
                            <button wire:click="delete({{ $penempatan->id }})"
